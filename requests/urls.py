...
urlpatterns = [
    ...
    path("rules/", views.request_rules, name="request_rules"),
    path("new/", views.employee_request_create, name="employee_request_create"),
    path("<int:pk>/attachment/", views.request_attachment, name="request_attachment"),
    ...
    path("admin/<int:pk>/auto-approve/", views.admin_request_auto_approve, name="admin_request_auto_approve"),
    ...
    path("admin/<int:pk>/auto-assign/", views.admin_request_auto_assign, name="admin_request_auto_assign"),
    path("admin/<int:pk>/issue-inspection/", views.admin_request_issue_inspection, name="admin_request_issue_inspection"),
